...
SAS_new %>% summarise(min_Bus_Days_End_to_End = min(Bus_Days_End_to_End),
                   max_Bus_Days_End_to_End = max(Bus_Days_End_to_End),
                   mean_Bus_Days_End_to_End = mean(Bus_Days_End_to_End),
                   )
